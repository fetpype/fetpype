...
def nesvor_recon(stacks, masks, pre_command="", nesvor_image=""):
    """
    Function wrapping NeSVoR's reconstruction for use with nipype
    ...
    Inputs:
        ...
        nesvor_image:
            nesvor_image name (e.g. junshenxu/nesvor:v0.5.0 latest)
    ...
    if "docker" in pre_command:
        ...
        cmd += (
            ...
            f"-v {masks_dir}:/masks "
            f"-v {reconst_dir}:/rec "
            f"{nesvor_image} niftymic_run_reconstruction_pipeline "
